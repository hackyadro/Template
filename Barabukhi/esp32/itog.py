...
def update_map():
    ...
    url_post = "http://172.20.10.2:8000/get_map"
...
def update_freq():
    ...
    url_post = "http://172.20.10.2:8000/get_freq"
    payload = {"mac": MAC_ADDRESS}
    status, body = do_post(url_post, json_dict=payload)
    # status = 200
    # body = '{"freq": 1}'
...
def update_status_road():
    ...
    url_post = "http://172.20.10.2:8000/get_status_road"
    payload = {"mac": MAC_ADDRESS}
    status, body = do_post(url_post, json_dict=payload)
    # status = 200
...
def ping_server():
    ...
    url_post = "http://172.20.10.2:8000/ping"
    payload = {"mac": MAC_ADDRESS}
    status, body = do_post(url_post, json_dict=payload)
